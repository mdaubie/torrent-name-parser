...
public interface FilenameParser {
    ...
    static ParsedFilename parseFilename(String text) throws InvalidParameterException {
        ...
        if (count != 0) {
            return ParsedFilename.get(title, season, episode, year, release, resolution, quality, codec, audio, team, language, extension);
        } else {
            throw new InvalidParameterException("File could not be identified as subtitles or video file, check the extension");
        }
    }
